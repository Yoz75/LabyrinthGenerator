...
## What is this
This is a CLI program for creating labyrinths using various algorithms (you can switch them using --type option. Currently there is only 1 algorythm)
## Why I need this?
Idk why not?
## How to build this
Open VS solution and build the program!
## How to get help?
Run lbgen --help. All commands have a small description
